...
const toastReducer = (
  state: ToastState,
  action: Partial<ToastState> | { type: 'dismiss' }
): ToastState => {
  if ('type' in action && action.type === 'dismiss') {
    return { ...state, open: false };
  }
  return { ...state, open: true, ...(action as Partial<ToastState>) };
};

let toastDispatch: React.Dispatch<Partial<ToastState> | { type: 'dismiss' }> | null = null;
